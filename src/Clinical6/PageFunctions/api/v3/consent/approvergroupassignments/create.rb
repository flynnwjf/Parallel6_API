    ...
    module ApproverGroupAssignments
      class Create < BaseAPI
        ...
        private def post_create
          response = RestClient.post("https://#{@env}/v3/consent/approver_group_assignments", payload.to_json,
        ...
        attr_reader :email, :password, :environment, :id, :form_version_id, :group_id
