...
#Test Info
  ...
  it 'C13795 Allows user to have their eCOA surveys captured and saved.', test_id: 'C13795' do
    test_rail_expected_steps(3)

    #Step1 Make a Post request on {{protocol}}{{url}}/v3/mobile_users/sessions
    test_rail_expected_result(1, "mobile user session is created, identify the mobile user id")
    #Super User Session
