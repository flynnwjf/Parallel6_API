...
#Test Info
  ...
  it 'C14622 The System Administrator should be able to update the profile associated with a mobile user', test_id: 'C14622' do
    test_rail_expected_steps(3)

    #Step1 The user makes a POST request on {{protocol}}{{url}}/v3/mobile_users/sessions
    test_rail_expected_result(1, "User can 200 response and catch mobile user id")
    #Mobile User Session
    ...
    test_rail_expected_result(2, "User can get 200 response and changes are updated to mobile user profile")
    #Super User Session
    ...
    test_rail_expected_result(3, "User can get 200 response with the updated profile displayed")
