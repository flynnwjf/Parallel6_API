...
#Main User(s)
  ...
  it 'C13803 Allows users to receive a reminder to complete eCOA surveys according to the schedule.', test_id: 'C13803' do
    ...
    test_rail_expected_result(3, "The User is able to view the notification delivery and observe the customized reminder asking them to complete an entry")
